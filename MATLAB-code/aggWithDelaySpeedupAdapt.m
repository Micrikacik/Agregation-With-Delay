function [xRec, thetaRec, thetaOccur, xInitHist, xHist, rngSetts] = aggWithDelaySpeedupAdapt(expParams)
...
for t=1:T
    ...
    G_norm = min(median(G_vals),1/100);
    adt = sqrt(dt) / G_norm / 100;
    updt = adt * G_vals .* randn(N,d);
