function [expsParams, folderPathFunc, filePostfixFunc] = makeDelayExpsParamsComplex(d, stepDelays, delayType, dt)
...
expsParams = struct( ...
        "N", cell(length(stepDelays), 1), ... % Set the length of the structure array
        "d", [], ...
        "stepCount", [], ...
        "dt", [], ...
        "delayType", [], ...
